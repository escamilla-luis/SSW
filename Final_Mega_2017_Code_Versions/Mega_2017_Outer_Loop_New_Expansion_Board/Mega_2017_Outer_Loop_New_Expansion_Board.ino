 ...
 *  MISO (PIN 50), RST (PIN 8).
 */
#define motor1          6   // Interrupt 0
#define motor2          7   // Interrupt 1
#define SERVO           5   // Servo pin
#define RED             10  // STOP and Error status
#define GREEN           11  // GO status
#define BLUE            12  // Status of the podcar
...
{ 
  ...
  // This is only available in Scheduling Arduino File named Mega_2017_Scheduling.ino or Mega_2017_Scheduling_New_Expansion_Board.ino
...
//    Serial.println("pos1");
//    Serial.println(pos1); //274 without metal strip/ 260 with metal strip
//    Serial.println("pos2");
//    Serial.println(pos2); // 300 no strip/ strip is 280 max
...
//  Serial.println(getStationNumber());
//  Serial.println("Checkpoint");
//  Serial.println(getCheckpointNumber());
...
bool isSomethingInFront() {
  ...
  // Check if something is in front of either of them
    ...
    // Test ultrasonics here
//    Serial.println("echoStartFront");
//    Serial.println(echoStartFront);
//    Serial.println("echoEndFront");
//    Serial.println(echoEndFront);
//    Serial.println("echoDurationFront");
//    Serial.println(echoDurationFront);
...
//    if (killStatePressedTwice % 2 == 0 && killPressedOnce) {
//      SERVOINT = 20;
//      leverArm.write(SERVOINT);  
//      killStatePressedTwice++;
//      killPressedOnce = false;
//    }
//    else if (killStatePressedTwice % 2 == 0) {
//      // Only pressed once.
//    }
//    else {
//      SERVOINT = 140;
...
//   */
//
//   digitalWrite(TRIGSIDE, OFF);
//   delayMicroseconds(2);
//
//   digitalWrite(TRIGSIDE, ON);
//   delayMicroseconds(10);
//
//   digitalWrite(TRIGSIDE, OFF);
//
//   // Returns the length of the pulse in microseconds
//   duration = pulseIn(ECHOSIDE, ON);
//
//   // Calculate the distance (in cm) based on the speed of sound
//   distance = duration/58.2;
//}
